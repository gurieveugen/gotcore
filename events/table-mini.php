...
?>
<h4 class="cal-header"><?php echo $tribe_ecp->monthsFull[date('M',$date)]; echo date(' Y',$date); ?> <a class="tribe-view-all-events" href="<?php echo tribe_get_events_link(); ?>"><?php _e('View all &raquo;', 'tribe-events-calendar'); ?></a></h4>
