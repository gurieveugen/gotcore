...
if ( is_tax( $tribe_ecp->get_event_taxonomy() ) ) {
    $event_slug = get_query_var('term');

} 
global $set_event_category;
if ( $set_event_category ) {
    $event_slug = $set_event_category;
}
if ( $event_slug ) {
    $cat = get_term_by( 'slug', $event_slug, $tribe_ecp->get_event_taxonomy() );
...
?>
<table class="tribe-events-calendar" id="big" width="100%" style="width: 100%">
	<thead>
			<tr>
				<?php
